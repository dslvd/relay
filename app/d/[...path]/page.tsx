...
export default function DownloadPage() {
  ...
  // served from /dl/{key} (see app/dl/[...path]/route.ts).
  const downloadUrl = `/dl/${pathKey}`;
  const downloadPageUrl = `/d/${pathKey}`;
    ...
    const fetchFileData = async () => {
      try {
        ...
        fetch('/api/analytics', {
          ...
          body: JSON.stringify({ type: 'pageview', path: `/d/${pathKey}` })
        }).catch(() => {}); // Silently fail
              ...
              <>
                ...
                <a
                  ...
                  onClick={(e) => {
                    ...
                    // reliably regardless of whether the /dl/[...] proxy route
